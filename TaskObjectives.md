For this assignment, trainees will be working with MongoDB using the MongoDB shell. They should create a README file in their repositories that outlines the specific MongoDB shell commands used to achieve project outcomes. The README should also provide clear instructions on how to start the MongoDB shell (Mongosh) and utilise the necessary commands effectively.
